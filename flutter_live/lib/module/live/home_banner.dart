...
import 'package:flutter_live/entity/story.dart';

class HomeBanner extends StatefulWidget {
  final List<StoryModel> bannerStories;
  final OnTapBannerItem onTap;
  double barHeight = 226.0;

  HomeBanner(this.bannerStories, this.onTap, this.barHeight, {Key key})
      : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _BannerState(barHeight);
  }
}
