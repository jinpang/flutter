...
class RankListRefresh extends StatefulWidget {
  Function getRankContentItem;
  List<RankItemModel> dayList;

  RankListRefresh([this.getRankContentItem, this.dayList]) : super();

  @override
  State<StatefulWidget> createState() => _RankListRefreshState();
}

class _RankListRefreshState extends State<RankListRefresh> with AutomaticKeepAliveClientMixin{
    ...
    return RefreshIndicator(
      child: ListView.separated(
        ...
        itemBuilder: (BuildContext context, int index) {
          RankItemModel model = widget.dayList[index];
          return widget.getRankContentItem(model.rankNo, model.image,
              model.nickname, model.rankValue);
        },
        controller: null,
      ),
